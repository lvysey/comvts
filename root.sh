...
UUID=${UUID:-'51232300-66a0-44b7-a338-af74b72f46ac'}
VMESS_WSPATH=${VMESS_WSPATH:-'/e3ecL'}
VLESS_WSPATH=${VLESS_WSPATH:-'/U3Y0Bb18peJD'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/LSwjEaC'}
SS_WSPATH=${SS_WSPATH:-'/YMRyil'}
